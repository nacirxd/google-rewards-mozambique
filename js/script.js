...
const surveyData = {
    ...
    questions: [
        {
            text: "Qual é a sua operadora de telefone móvel preferida em Moçambique?",
            options: [
                { text: "Vodacom", emoji: "📱" },
                { text: "Movitel", emoji: "📲" },
                { text: "TMcel", emoji: "☎️" }
        ...
        {
            text: "Como você classifica os serviços bancários em Moçambique?",
            options: [
        ...
        },
        {
            ...
            options: [
                { text: "Marcas locais moçambicanas", emoji: "🇲🇿" },
...
function showCurrentQuestion() {
    ...
    questionValue.textContent = `Vale: ${currentQuestion.reward} MZN`;
...
function showRewardPopup(amount) {
    ...
    rewardAmount.textContent = `+${amount} MZN`;
